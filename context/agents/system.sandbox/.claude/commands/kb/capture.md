...
Executa `uv run python scripts/kb/flush.py` a partir da raiz do projeto, passando o contexto da conversa atual.

Passos:
1. Resuma a conversa atual em formato de daily log (seguindo o template em AGENTS.md)
