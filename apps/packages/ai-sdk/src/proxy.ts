...
import type { WebSearchProvider, WebSearchResult } from "./tools/web-search.js";
import { braveSearch } from "./tools/brave-search.js";

/**
 * DuckDuckGo HTML search scraper — no API key needed.
 */
async function duckDuckGoSearch(query: string, numResults = 5): Promise<WebSearchResult[]> {
...
export async function* runAgent(raw: unknown): AsyncGenerator<AgentEvent> {
