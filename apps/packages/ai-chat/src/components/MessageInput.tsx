...
// ── Agent Dropdown (shared by badge click and @mention) ──
...
export function MessageInput({
  ...
  // Agent dropdown — triggered by @mention OR badge click
  ...
  useEffect(() => { setMentionIndex(0); }, [agentQuery]);
  ...
  function handleKeyDown(e: React.KeyboardEvent<HTMLTextAreaElement>) {
    // Agent dropdown navigation (shared by @mention and badge click)
  ...
  return (
    ...
    >
      ...
      {/* ── Agent dropdown (shared: @mention + badge click) ── */}
